...
function hclToRgb(h, c, l) {
  ...
  const q = lNorm < 0.5 ? lNorm * (1 + adjS) : lNorm + adjS - lNorm * adjS;
  const p = 2 * lNorm - q;
  return [
...
function generateHclPalette(n, hStart = 15, hEnd = 375, c = 60, l = 65) {
  const colors = [];
...
function colorPalette(nStates, palette) {
  if (nStates <= 0) return [];
  if (palette) {
    let base;
    switch (palette) {
...
function createColorMap(labels, colors) {
...
export { ACCENT_PALETTE, DEFAULT_COLORS, SET3_PALETTE, colorPalette, createColorMap, darkenColor, hexToRgb, lightenColor, rgbToHex };
//# sourceMappingURL=chunk-7SYEF5ZL.js.map
//# sourceMappingURL=chunk-7SYEF5ZL.js.map
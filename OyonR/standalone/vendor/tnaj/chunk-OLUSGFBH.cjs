...
function buildGroupModels(data, groups, options) {
  ...
  for (const grp of uniqueGroups) {
    ...
    models[grp] = chunkRT5XI5AH_cjs.buildModel(grpData, optsNoScaling);
  }
  if (scalingOpt) {
...
function groupAtna(data, groups, options) {
  return buildGroupModels(data, groups, {
    ...options,
    type: "attention",
    params: { beta: options?.beta ?? chunkRT5XI5AH_cjs.ATTENTION_DEFAULT_BETA }
  });
}

exports.createGroupTNA = createGroupTNA;
exports.groupApply = groupApply;
exports.groupAtna = groupAtna;
exports.groupCtna = groupCtna;
exports.groupEntries = groupEntries;
exports.groupFtna = groupFtna;
exports.groupNames = groupNames;
exports.groupTna = groupTna;
exports.isGroupTNA = isGroupTNA;
exports.isHtna = isHtna;
exports.renameGroups = renameGroups;
//# sourceMappingURL=chunk-OLUSGFBH.cjs.map
//# sourceMappingURL=chunk-OLUSGFBH.cjs.map
import { SeededRNG, Matrix, createTNA } from './chunk-2EXGRQR6.js';
...
function mmm(data, options) {
  ...
  for (let r = 0; r < nStarts; r++) {
    ...
    if (explicitInit) {
      ...
      const rng = new SeededRNG(seed + r >>> 0);
      for (let i = 0; i < n; i++) {
        let rsum = 0;
        for (let m = 0; m < k; m++) {
          const v = rng.random();
...
export { clusterMmm, fitMultinom, invertMatrix, mmm, mmmAssign, multinomSE, solveLinear, validateMmmOptions };
//# sourceMappingURL=chunk-ZCVPZDHU.js.map
//# sourceMappingURL=chunk-ZCVPZDHU.js.map
...
| [dynajs](https://github.com/mohsaqr/dynajs) 0.1.0 | resolved as the sibling dependency `file:../dynajs` | bundled into the client analytics build; copied to `/opt/dynajs` in the runtime image |
